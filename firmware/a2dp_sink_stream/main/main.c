...
/*
    ...
    led 1 : GPIO 27
    led 2 : GPIO 13
    VSNS : GPIO 36 - sensor vp
*/

#define input_touch_1 26
#define input_touch_2 25
#define input_touch_3 33
#define input_touch_4 32
#define output_led_1 27
#define output_led_2 13

#define DEFAULT_VREF    1100        
#define NO_OF_SAMPLES   64          //Multisampling
#define input_vsns 36 //ADC1_CH0
#if CONFIG_IDF_TARGET_ESP32
...
{   
    ...
    esp_bt_dev_set_device_name("VITST");
